export const Hero = () => {
  return (
    <main className="relative mt-16 md:mt-[4.15rem]">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 lg:space-x-7">
              <button className="rounded-lg bg-black text-white px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-base sm:text-lg hover:bg-black/90 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                Get Started
              </button>
              <button className="rounded-lg border-2 border-black text-black px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-base sm:text-lg hover:bg-black/5 transform hover:-translate-y-1 transition-all duration-300">
                Learn More
              </button>
            </div>
          </div>
